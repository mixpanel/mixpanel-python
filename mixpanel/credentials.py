...
class ServiceAccountCredentials:
    ...
    def __init__(self, username: str, secret: str, project_id: str):
        if not isinstance(username, str):
            raise TypeError("Service account username must be a string")
        if not isinstance(secret, str):
            raise TypeError("Service account secret must be a string")
        if not isinstance(project_id, str):
            raise TypeError("Service account project_id must be a string")
